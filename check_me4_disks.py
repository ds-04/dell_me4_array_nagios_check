def check_me4_disks(data):
    ...
    if len(disks_faulty) > 0:
     for k in disks_faulty:
       ...
       message_list.append(str(k.get("enclosure-id", "Unknown")))
       message_list.append(" slot - ")
       message_list.append(str(k.get("slot", "Unknown")))
       message_list.append(" s/n - ")
       message_list.append(k.get("serial-number", "Unknown"))
       message_list.append(" model - ")
       message_list.append(k.get("model", "Unknown"))
       message_list.append(" size - ")
       message_list.append(k.get("size", "Unknown"))
       message_list.append(" health - ")
       message_list.append(k.get("health", "Unknown"))
       message_list.append(" ")
       message_list.append(" | ")
